<template>
    <div>
        <Tabs v-model="current.operation">
            <TabPane label="正则测试" name="test">
                <Row :gutter="16" style="margin-bottom: 10px">
                    <Col span="12">
                        <Input v-model="current.input">
                            <Select slot="prepend" @on-change="commonSelect" placeholder="正则表达式" style="width:100px">
                                <Option style="text-align: left" v-for="(v,k) in regex" :value="v.regex" :key="k">{{ v.name }}</Option>
                            </Select>
                        </Input>
                    </Col>
                    <Col span="12">
                        <Input v-model="current.replace">
                            <span slot="prepend">替换内容</span>
                        </Input>
                    </Col>
                </Row>
                <Row :gutter="16">
                    <Col span="12">
                        <Input v-model="current.content" :rows="10" type="textarea" placeholder="内容"></Input>
                    </Col>
                    <Col span="12">
